...
each other. The function implicitly creates objects (\CppXrefInAccord{7.2})
...
operates on individual bytes.]%\end{note}
...
(\CppXrefInAccord{6.7.2}) in the destination region of storage immediately
