...
implemented version inlined into \tcode{std::experimental}.
...
will be moved into the next version of the C++ Standard by removing the \tcode{experimental::concurrency\_vN} segment of its
