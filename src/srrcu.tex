...
This class meets the requirements of \oldconcept{BasicLockable} \tcode{[thread.req.lockable.basic]} and provides regions of RCU protection.
...
(\CppXref{16.4.6.10}) involving \tcode{*this}.
