...
\begin{enumerate}
\item	Mandates: \tcode{is_move_constructible_v<D>} is true.
\item	Preconditions: \tcode{D} meets the Cpp17MoveConstructible and
	Cpp17Destructible requirements.
	The expression \tcode{d1(p)}, where \tcode{d1} is defined below,
