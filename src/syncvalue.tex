...
This clause describes a class template to provide locked access to a
...
\begin{note} The invocation of \tcode{f} cannot call \tcode{apply}
directly or indirectly passing any of \tcode{values...}.\end{note}
\end{itemdescr}
